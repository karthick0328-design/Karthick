...
export default function HeadHRDepartmentComplaintsPage() {
    return (
        <div className="space-y-8 animate-in fade-in duration-500">
            <div>
                <h1 className="text-2xl font-black text-slate-900 flex items-center gap-3 tracking-tight">
                    <ShieldCheck className="w-7 h-7 text-indigo-600" />
                    Human Resource Department Complaints
                </h1>
                <p className="text-slate-500 mt-1 font-medium">Executive oversight of service complaints within the Human Resource department.</p>
            </div>
