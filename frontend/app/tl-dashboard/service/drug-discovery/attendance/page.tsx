...
const DrugDiscoveryTLAttendancePage = () => {
                ...
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-lg text-gray-500 mt-2 max-w-2xl">
                            Daily check-in and leave management portal for Drug Discovery Team Leads.
                        </p>
                    </div>
...
export default DrugDiscoveryTLAttendancePage;
