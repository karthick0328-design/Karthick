...
export default function DrugDiscoveryProjects() {
  ...
  useEffect(() => {
    const fetchProjects = async () => {
      ...
      try {
        ...
        const res = await fetch('http://localhost:5000/api/adminassignments/projects/drug-discovery', {
        ...
        console.error("Error fetching drug discovery projects:", err);
      } finally {
        setLoading(false);
      }
    };
        ...
        <main className="flex-1 overflow-y-auto p-8">
          <div className="max-w-7xl mx-auto space-y-6">
            <div className="flex justify-between items-center bg-white p-6 rounded-xl shadow-sm border border-gray-100">
              <div>
                <h1 className="text-2xl font-bold text-gray-900">Drug Discovery Projects</h1>
                <p className="text-gray-500 mt-1">Manage and monitor all drug discovery initiatives</p>
              </div>
            </div>
            ...
            {loading ? (
              ...
              <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-12 text-center text-gray-500">
                ...
                <p className="text-lg">No drug discovery projects found</p>
              </div>
            ) : (
                  ...
                  <div key={project._id} className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 hover:shadow-md transition-shadow">
                    ...
                    <div className="mt-6 pt-4 border-t border-gray-100">
                      <button 
                        ...
                        className="flex justify-center items-center w-full px-4 py-2 text-sm font-medium text-green-700 bg-green-50 rounded-lg hover:bg-green-100 transition-colors"
                      >
                        View Details
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm animate-in fade-in duration-200">
          <div className="bg-white rounded-2xl w-full max-w-2xl max-h-[90vh] overflow-hidden shadow-2xl flex flex-col animate-in zoom-in-95 duration-200">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-4">
                <div>
                  <h4 className="text-sm font-bold text-gray-900 mb-4 flex items-center gap-2">
                    <Users size={18} className="text-green-600" /> Client Information
                  </h4>
                  <div className="space-y-3">
                    <div className="flex items-center gap-3">
                ...
                <div>
                  <h4 className="text-sm font-bold text-gray-900 mb-4 flex items-center gap-2">
                    <Activity size={18} className="text-blue-600" /> Assigned Lead
                  </h4>
                  <div className="flex items-center gap-3">
            ...
            <div className="p-6 border-t border-gray-100 bg-gray-50/50 flex justify-end gap-3">
              ...
              <button className="px-6 py-2 text-sm font-bold text-white bg-green-600 rounded-xl hover:bg-green-700 transition-all shadow-md shadow-green-100">
                Manage Project
              </button>
            </div>
          </div>
