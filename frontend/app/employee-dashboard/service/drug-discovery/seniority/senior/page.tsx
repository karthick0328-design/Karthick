...
// --- Main Component -----------------------------------------------------------
export default function SeniorDrugDiscoveryDashboard() {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/20 to-indigo-50/30 font-sans">
            {/* -- Hero Header -- */}
            <div className="relative overflow-hidden bg-gradient-to-r from-indigo-900 via-blue-900 to-teal-900">
                        ...
                        <div>
                            <div className="flex items-center gap-3 mb-3">
                                <div className="p-3 bg-white/10 backdrop-blur-sm rounded-2xl border border-white/20">
                                    <Microscope size={28} className="text-teal-300" />
                                </div>
                                <div>
                                    <div className="flex items-center gap-2 mb-1">
                                        <span className="text-teal-300 text-xs font-bold uppercase tracking-widest">Employee Portal</span>
                                    ...
                                    <h1 className="text-3xl font-extrabold text-white tracking-tight">Drug Discovery Dashboard</h1>
                                </div>
                            </div>
