...
const DrugDiscoveryJuniorAttendancePage = () => {
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-3xl font-bold text-slate-900 flex items-center gap-3 uppercase">
                        Drug Discovery <span className="text-indigo-600">Junior Attendance</span>
                    </h1>
...
export default DrugDiscoveryJuniorAttendancePage;
