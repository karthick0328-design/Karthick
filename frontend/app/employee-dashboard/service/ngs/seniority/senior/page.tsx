...
// --- Main Component -----------------------------------------------------------
export default function SeniorNGSDashboard() {
                        ...
                        <div>
                            <div className="flex items-center gap-3 mb-3">
                                <div className="p-3 bg-white/10 backdrop-blur-sm rounded-2xl border border-white/20">
                                    <Activity size={28} className="text-orange-300" />
                                </div>
                                <div>
                                    <div className="flex items-center gap-2 mb-1">
                                        <span className="text-orange-300 text-xs font-bold uppercase tracking-widest">Employee Portal</span>
                                    ...
                                    <h1 className="text-3xl font-extrabold text-white tracking-tight">NGS Dashboard</h1>
                                </div>
                            </div>
