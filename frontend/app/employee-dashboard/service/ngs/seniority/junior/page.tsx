...
import {
    ...
    Search, Activity, Microscope, Briefcase, AlertCircle, ArrowRight, X, Send,
...
// --- Main Component -----------------------------------------------------------
export default function JuniorNGSDashboard() {
    ...
    return (
        <div className="space-y-8 pb-8">
            ...
            <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }}
                className="relative rounded-3xl overflow-hidden bg-gradient-to-r from-teal-600 via-emerald-600 to-indigo-500 p-6 shadow-xl shadow-teal-500/20">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <div className="flex items-center gap-2 mb-0.5">
                                <span className="text-white/60 text-xs font-bold uppercase tracking-widest">NGS</span>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                <StatCard title="Total Assigned" value={stats.total} icon={Briefcase} gradient="from-teal-500 to-teal-700" delay={0.05} />
                <StatCard title="In Progress" value={stats.inProgress} icon={Activity} gradient="from-emerald-500 to-teal-600" delay={0.1} />
                <StatCard title="Completed" value={stats.completed} icon={CheckCircle2} gradient="from-blue-500 to-indigo-600" delay={0.15} />
                ...
                <AnimatePresence>
                    {loading ? (
                        ...
                        filteredProjects.map((project, index) => (
                            ...
                            >
                                <div className="h-1 bg-gradient-to-r from-teal-500 via-emerald-500 to-indigo-400" />
                                <div className="p-6">
                                    {/* Title row */}
                                    ...
                                    {/* Client */}
                                    <div className="flex items-center gap-3 p-3 bg-gradient-to-r from-teal-50/50 to-emerald-50/30 rounded-2xl mb-4 border border-teal-100/50">
                                    ...
                                    {project.activities && project.activities.length > 0 && (
                                        <div className="mb-4 bg-gradient-to-br from-teal-50/50 to-emerald-50/30 rounded-2xl p-4 border border-teal-100/50">
                                    ...
                                    <div className="flex items-center gap-2 pt-4 border-t border-gray-100">
                                        {['Assigned', 'Under Review'].includes(project.status) && (
                                            <button onClick={() => handleStartTask(project._id)}
                                                ...
                                                className="flex-1 bg-gradient-to-r from-teal-600 to-emerald-600 hover:from-teal-700 hover:to-emerald-700 text-white py-2.5 rounded-xl font-bold text-sm flex items-center justify-center gap-2 transition-all shadow-md shadow-teal-500/20 disabled:opacity-50">
                                        ...
                                        {project.status === 'In Progress' && (
                                            <button onClick={() => handleUpdateTask(project)}
                                                disabled={actionLoading === project._id}
                                                className="flex-1 bg-gradient-to-r from-teal-500 to-emerald-500 hover:from-teal-600 hover:to-emerald-600 text-white py-2.5 rounded-xl font-bold text-sm flex items-center justify-center gap-2 transition-all shadow-md shadow-teal-500/20 disabled:opacity-50">
