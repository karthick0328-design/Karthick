...
// --- Main Component -----------------------------------------------------------
export default function JuniorSoftwareDevelopmentDashboard() {
    ...
    return (
        <div className="space-y-8 pb-8">
            ...
            <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }}
                className="relative rounded-3xl overflow-hidden bg-gradient-to-r from-blue-600 via-indigo-600 to-violet-500 p-6 shadow-xl shadow-blue-500/20">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <div className="flex items-center gap-2 mb-0.5">
                                <span className="text-white/60 text-xs font-bold uppercase tracking-widest">Software Dev</span>
                ...
                <AnimatePresence>
                    {loading ? (
                        ...
                        filteredProjects.map((project, index) => (
                            ...
                            >
                                <div className="h-1 bg-gradient-to-r from-blue-500 via-indigo-500 to-violet-400" />
                                <div className="p-6">
                                    {/* Title row */}
