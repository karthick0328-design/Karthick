...
// --- Main Component -----------------------------------------------------------
export default function SeniorSoftwareDevelopmentDashboard() {
                        ...
                        <div>
                            <div className="flex items-center gap-3 mb-3">
                                ...
                                <div>
                                    ...
                                    <h1 className="text-3xl font-extrabold text-white tracking-tight">Software Development Dashboard</h1>
                                </div>
                            </div>
