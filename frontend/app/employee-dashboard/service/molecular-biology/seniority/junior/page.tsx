...
// --- Main Component -----------------------------------------------------------
export default function JuniorMolecularBiologyDashboard() {
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <div className="flex items-center gap-2 mb-0.5">
                                <span className="text-white/60 text-xs font-bold uppercase tracking-widest">Molecular Biology</span>
