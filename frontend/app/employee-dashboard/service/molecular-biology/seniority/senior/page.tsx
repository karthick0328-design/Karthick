...
// --- Main Component -----------------------------------------------------------
export default function SeniorMolecularBiologyDashboard() {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-slate-50 via-indigo-50/20 to-blue-50/30 font-sans">
            {/* -- Hero Header -- */}
            <div className="relative overflow-hidden bg-gradient-to-r from-indigo-900 via-slate-900 to-zinc-900">
                            ...
                            <div className="flex items-center gap-3 mb-3">
                                ...
                                <div>
                                    <div className="flex items-center gap-2 mb-1">
                                        <span className="text-gray-300 text-xs font-bold uppercase tracking-widest">Employee Portal</span>
                                    ...
                                    <h1 className="text-3xl font-extrabold text-white tracking-tight">Molecular Biology Dashboard</h1>
                                </div>
                            </div>
            ...
            <div className="max-w-7xl mx-auto px-6 py-8 space-y-8">
                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                    <StatCard title="Total Assigned" value={stats.total} icon={Briefcase} gradient="from-indigo-500 to-indigo-700" delay={0.05} />
                    ...
                    <StatCard title="Pending / Assigned" value={stats.pending} icon={Clock} gradient="from-amber-500 to-indigo-500" delay={0.2} />
                </div>
