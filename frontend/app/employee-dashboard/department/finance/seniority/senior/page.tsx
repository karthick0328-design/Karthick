...
import { DollarSign, Briefcase, ArrowRight, Package } from 'lucide-react';
import Link from 'next/link';

export default function FinanceSeniorEmployeePage() {
    return (
        <div className="space-y-8 pb-20">
            {/* Header Section */}
            <div className="bg-gradient-to-r from-emerald-900 to-emerald-800 rounded-[32px] p-10 text-white relative overflow-hidden shadow-2xl shadow-emerald-900/20">
                ...
                <div className="relative z-10">
                    ...
                    <p className="text-emerald-100 max-w-2xl text-lg">
                        Senior Finance Employee Portal - Access salary processing, service payments, and brand purchase logistics.
                    </p>
            ...
            {/* Info Card */}
            <div className="bg-gradient-to-br from-emerald-50 to-blue-50 border border-emerald-100 rounded-[32px] p-8">
                <div className="flex items-start gap-4">
                    ...
                    <div>
                        <h3 className="text-xl font-black text-slate-900 mb-2 tracking-tight">Senior Employee Access</h3>
                        <p className="text-slate-700 leading-relaxed">
                            As a senior finance employee, you have access to all financial operations including
                            salary processing and service payment monitoring. Your role is crucial in maintaining financial integrity
                            and ensuring timely payment processing across all departments.
                        </p>
                    </div>
                </div>
            </div>
