...
export default function ProjectDetailsPage() {
    ...
    const fetchTLs = async () => {
        try {
            const token = localStorage.getItem('token');
            const response = await fetch(`${API_BASE}/department/tls`, {
                headers: { 'Authorization': `Bearer ${token}` }
            });
            const data = await response.json();
            if (data.success) {
        ...
        return (
            <div className="min-h-[400px] flex items-center justify-center">
                <div className="text-center">
                    <Beaker className="w-12 h-12 text-teal-600 animate-bounce mx-auto mb-4" />
    ...
    if (!project) {
        return (
            <div className="text-center py-20">
                ...
                <Link href="/manager-dashboard/service/drug-discovery" className="text-teal-600 font-semibold hover:underline flex items-center justify-center gap-2">
    ...
    return (
        <div className="font-sans">
            ...
            <ServiceProjectDetailView
                ...
                serviceTitle="Drug Discovery Unit"
                serviceIcon={<Beaker className="w-5 h-5" />}
                breadcrumb="MANAGER DASHBOARD / SERVICE / DRUG DISCOVERY"
                backUrl="/manager-dashboard/service/drug-discovery"
                workflowBar={
                    <div className="p-10">
                        <div className="relative flex items-center justify-between max-w-4xl mx-auto">
                            ...
                            {[
                                ...
                                { step: 2, label: 'Molecule Sync', icon: GitBranch },
                                { step: 3, label: 'Lead Assign', icon: UserPlus },
                                { step: 4, label: 'Discovery', icon: Activity }
                            ].map((item) => {
            ...
            {/* Modals - Same logic as main dashboard */}
            {/* Start Task Modal */}
            {showTaskModal && (
                <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
                    <div className="bg-white rounded-2xl shadow-2xl max-w-lg w-full p-8 animate-in zoom-in duration-200">
                        <h2 className="text-2xl font-bold text-gray-900 mb-4 flex items-center gap-2">
                            <PlayIcon className="w-6 h-6 text-blue-500 fill-current" />
                            Start Project Task
                        </h2>
                        <label className="block mb-6">
                            ...
                            <textarea
                                ...
                                className="w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent min-h-[120px]"
                                placeholder="Add any initial notes about this task..."
                            />
                        </label>
                        <div className="flex gap-3">
                            <button onClick={handleStartTask} className="flex-1 bg-gradient-to-r from-blue-600 to-indigo-600 text-white py-3 rounded-xl font-bold shadow-lg hover:from-blue-700 hover:to-indigo-700 transition-all">Start Task</button>
                    ...
                    <div className="bg-white rounded-2xl shadow-2xl max-w-lg w-full p-8 animate-in zoom-in duration-200">
                        ...
                        <div className="space-y-4 mb-6">
                            ...
                            <label className="block">
                                ...
                                <textarea
                                    ...
                                    className="w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-teal-500 focus:border-transparent min-h-[150px]"
                            ...
                            <div className="block">
                                ...
                                <div className="border-2 border-dashed border-gray-200 rounded-xl p-4 hover:border-teal-500 transition-colors bg-gray-50/50">
                                    <input
                                        type="file"
                                        multiple
                                        onChange={(e) => {
                        ...
                        <div className="flex gap-3">
                            <button
                                ...
                                className="flex-1 bg-gradient-to-r from-teal-600 to-emerald-600 text-white py-3 rounded-xl font-bold shadow-lg hover:from-teal-700 hover:to-emerald-700 transition-all disabled:opacity-50 flex items-center justify-center gap-2"
                            >
                                {uploading ? (
                                    <>
