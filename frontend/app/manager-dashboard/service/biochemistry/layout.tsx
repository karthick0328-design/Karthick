...
export default function BiochemistryServiceLayout({ children }: { children: React.ReactNode }) {
    ...
    return (
        <div className="fixed inset-0 bg-slate-50 flex overflow-hidden z-0">
            <ServiceSidebar
                ...
                servicePath="/manager-dashboard/service/biochemistry"
                className="fixed left-0 top-16 h-[calc(100vh-4rem)]" // Pass className or style if needed by original component
            />
