        ...
        <div className="space-y-8 animate-in fade-in duration-500">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    <h1 className="text-2xl font-bold text-slate-900 flex items-center gap-3">
                        ...
                        Biochemistry Dashboard
                    </h1>
                    <p className="text-slate-500 mt-1">Status of biochemical analysis and reports</p>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm relative overflow-hidden group hover:shadow-md transition-all">
                    ...
                    <div className="relative">
                        ...
                        <div className="text-xs text-slate-500 mt-1 flex items-center gap-1">
                            ...
                            <span className="text-emerald-600 font-medium">+5%</span> from last week
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm relative overflow-hidden group hover:shadow-md transition-all">
                    ...
                    <div className="relative">
                        <div className="flex items-center gap-3 mb-2">
                            ...
                            <span className="font-semibold text-slate-600">Analyzing</span>
                        </div>
                        <div className="text-3xl font-bold text-slate-900">{stats.inProgress}</div>
                        <div className="text-xs text-slate-500 mt-1">Lab work</div>
                    </div>
                </div>
                ...
                <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm relative overflow-hidden group hover:shadow-md transition-all">
                    ...
                    <div className="relative">
                        ...
                        <div className="text-xs text-slate-500 mt-1">Reports delivered</div>
                    </div>
                </div>
            </div>
            ...
            <div className="bg-white rounded-3xl border border-slate-200 shadow-sm overflow-hidden max-h-[800px] overflow-y-auto custom-scrollbar">
                <div className="p-6 border-b border-slate-100 flex flex-col md:flex-row items-center justify-between gap-4">
                    <h2 className="text-lg font-bold text-slate-900">Active Biochemistry Projects</h2>
                                    ...
                                    <tr key={project._id} className="hover:bg-slate-50/50 transition-colors">
                                        ...
                                        <td className="px-6 py-4 text-right">
                                            <div className="flex items-center justify-end gap-2" onClick={(e) => e.stopPropagation()}>
                                                <Link
                                                    href={`/manager-dashboard/service/biochemistry/project/${project._id}`}
