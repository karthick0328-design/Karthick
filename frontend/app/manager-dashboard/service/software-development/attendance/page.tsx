...
const SoftwareDevelopmentAttendancePage = () => {
                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                    <div>
                        <div className="flex items-center gap-3 mb-3">
                            ...
                            <span className="px-3 py-1 bg-slate-100 text-slate-700 rounded-full text-xs font-bold tracking-wider uppercase">
                                Service Manager
                            </span>
                        </div>
                        <h1 className="text-4xl md:text-5xl font-black text-gray-900 tracking-tight leading-tight uppercase">
                            Software Development<span className="text-indigo-600"> Attendance</span>
                        </h1>
...
export default SoftwareDevelopmentAttendancePage;
