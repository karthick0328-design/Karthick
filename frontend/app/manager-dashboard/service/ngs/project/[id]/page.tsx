...
import {
    ...
    SendHorizonal, Paperclip, ClipboardList
} from 'lucide-react';
        ...
        return (
            <div className="min-h-[400px] flex items-center justify-center">
                <div className="text-center">
                    <Microscope className="w-12 h-12 text-teal-600 animate-spin mx-auto mb-4" />
    ...
    if (!project) {
        return (
            <div className="text-center py-20">
                ...
                <Link href="/manager-dashboard/service/ngs" className="text-blue-600 font-semibold hover:underline flex items-center justify-center gap-2">
    ...
    return (
        <div className="font-sans">
            ...
            <ServiceProjectDetailView
                ...
                serviceTitle="NGS Unit"
                serviceIcon={<Microscope className="w-5 h-5" />}
                breadcrumb="MANAGER DASHBOARD / SERVICE / NGS"
                backUrl="/manager-dashboard/service/ngs"
                workflowBar={
                    <div className="p-10">
                        <div className="relative flex items-center justify-between max-w-4xl mx-auto">
                            ...
                            {[
                                { step: 1, label: 'SM Review', icon: ShieldCheck, color: 'indigo' },
                                { step: 2, label: 'Dept Sync', icon: GitBranch, color: 'indigo' },
                                { step: 3, label: 'Lead Assign', icon: UserPlus, color: 'indigo' },
                                { step: 4, label: 'Work In Progress', icon: Activity, color: 'indigo' }
                            ].map((item) => {
                ...
                <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
                    <div className="bg-white rounded-2xl shadow-2xl max-w-lg w-full p-8 animate-in zoom-in duration-200">
                        <h2 className="text-2xl font-bold text-gray-900 mb-4 flex items-center gap-2">
                            <PlayIcon className="w-6 h-6 text-teal-500 fill-current" />
                            Start NGS Task
                        </h2>
                        <label className="block mb-6">
                            ...
                            <textarea
                                ...
                                className="w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-teal-500 focus:border-transparent min-h-[120px]"
                                placeholder="Add any initial notes about this task..."
                            />
                        </label>
                        <div className="flex gap-3">
                            <button onClick={handleStartTask} className="flex-1 bg-gradient-to-r from-teal-600 to-emerald-600 text-white py-3 rounded-xl font-bold shadow-lg hover:from-teal-700 hover:to-emerald-700 transition-all">Start Task</button>
                    ...
                    <div className="bg-white rounded-2xl shadow-2xl max-w-lg w-full p-8 animate-in zoom-in duration-200">
                        ...
                        <div className="space-y-4 mb-6">
                            <label className="block">
                                ...
                                <input
                                    ...
                                    placeholder="e.g., Sequencing Run Started"
                                />
                            </label>
                            <label className="block">
                                ...
                                <textarea
                                    ...
                                    className="w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-cyan-500 focus:border-transparent min-h-[150px]"
                        ...
                        <div className="flex gap-3">
                            <button
                                ...
                                className="flex-1 bg-gradient-to-r from-cyan-600 to-blue-600 text-white py-3 rounded-xl font-bold shadow-lg hover:from-cyan-700 hover:to-blue-700 transition-all disabled:opacity-50 flex items-center justify-center gap-2"
                            >
                                {uploading ? (
                                    <>
                ...
                <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
                    <div className="bg-white rounded-2xl shadow-2xl max-w-lg w-full p-8 animate-in zoom-in duration-200">
                        ...
                        <div className="bg-indigo-50 rounded-xl p-4 border border-indigo-100 mb-6">
                            <p className="text-sm text-indigo-800 font-medium">Warning: This will mark the project as completed. This action cannot be undone.</p>
                        </div>
                        <label className="block mb-6">
                            ...
                            <textarea
                                ...
                                className="w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-transparent min-h-[150px]"
                                placeholder="Summarize results and findings..."
                            />
                        </label>
                        <div className="flex gap-3">
                            <button
                                ...
                                className="flex-1 bg-gradient-to-r from-indigo-600 to-purple-600 text-white py-3 rounded-xl font-bold shadow-lg hover:from-indigo-700 hover:to-purple-700 transition-all disabled:opacity-50"
                            >
                                Complete Project
                            </button>
                    ...
                    <div className="bg-white rounded-2xl shadow-2xl max-w-lg w-full p-8 animate-in zoom-in duration-200">
                        ...
                        <div className="space-y-4 mb-6">
                            <div className="grid grid-cols-2 gap-4">
                                <button
                                    ...
                                    className={`p-4 rounded-xl border-2 flex flex-col items-center gap-2 transition-all ${reviewStatus === 'Approved' ? 'border-teal-500 bg-teal-50 text-teal-700' : 'border-gray-100 hover:border-teal-200'
                                        }`}
                                >
                                ...
                                <label className="block">
                                    ...
                                    <div className="relative">
                                        ...
                                        <input
                                            ...
                                            className="w-full pl-10 pr-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-teal-500 focus:border-transparent font-bold text-lg"
                                            placeholder="0.00"
                                        />
                                    </div>
                            ...
                            <label className="block">
                                ...
                                <textarea
                                    ...
                                    className="w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-teal-500 focus:border-transparent min-h-[100px]"
                        ...
                        <div className="flex gap-3">
                            <button
                                ...
                                className={`flex-1 py-3 rounded-xl font-bold shadow-lg transition-all disabled:opacity-50 flex items-center justify-center gap-2 ${reviewStatus === 'Approved' ? 'bg-teal-600 text-white hover:bg-teal-700' : 'bg-rose-600 text-white hover:bg-rose-700'
                                    }`}
                            >
            ...
            {showUploadModal && (
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-gray-900/60 backdrop-blur-sm" onClick={() => setShowUploadModal(false)}>
                    <div className="bg-white rounded-[2rem] shadow-2xl w-full max-w-lg overflow-hidden flex flex-col" onClick={e => e.stopPropagation()}>
                        <div className="px-8 py-6 bg-gradient-to-r from-teal-600 to-emerald-600 text-white flex justify-between items-center">
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-teal-100 text-xs">Add files to this project</p>
                                </div>
                            </div>
                        ...
                        <div className="p-8 space-y-6">
                            <label className="flex flex-col items-center justify-center w-full h-40 border-2 border-dashed border-gray-200 rounded-2xl bg-gray-50 hover:bg-gray-100 transition-all cursor-pointer group">
                                <div className="flex flex-col items-center justify-center pt-5 pb-6">
                                    <Paperclip size={32} className="text-teal-500 mb-3 group-hover:scale-110 transition-transform" />
                            ...
                            {uploadFiles.length > 0 && (
                                <div className="space-y-2">
                                    <div className="flex justify-between items-center">
                                        ...
                                        <span className="text-[10px] font-bold text-teal-600">{uploadFiles.length}/5</span>
                                    </div>
                            ...
                            <div className="flex gap-3 pt-2">
                                ...
                                <button
                                    ...
                                    className="flex-[2] flex items-center justify-center gap-2 px-6 py-3.5 bg-teal-600 text-white rounded-xl hover:bg-teal-700 transition-all font-bold text-xs uppercase tracking-widest shadow-lg shadow-teal-100 disabled:opacity-50"
                                >
                                    {isUploading ? (
