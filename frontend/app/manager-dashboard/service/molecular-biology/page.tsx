...
export default function MolecularBiologyDashboard() {
        ...
        <div className="space-y-8 animate-in fade-in duration-500">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    <h1 className="text-2xl font-bold text-slate-900 flex items-center gap-3">
                        ...
                        Molecular Biology Dashboard
                    </h1>
                    <p className="text-slate-500 mt-1">PCR, Cloning, and Molecular Analysis Projects</p>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm relative overflow-hidden group hover:shadow-md transition-all">
                    ...
                    <div className="relative">
                        ...
                        <div className="text-xs text-slate-500 mt-1">Extraction & Analysis</div>
                    </div>
                </div>
                ...
                <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm relative overflow-hidden group hover:shadow-md transition-all">
                    ...
                    <div className="relative">
                        ...
                        <div className="text-xs text-slate-500 mt-1">For approval</div>
                    </div>
                </div>
                ...
                <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm relative overflow-hidden group hover:shadow-md transition-all">
                    ...
                    <div className="relative">
                        ...
                        <div className="text-xs text-slate-500 mt-1">Results delivered</div>
                    </div>
                </div>
            </div>
            ...
            <div className="bg-white rounded-3xl border border-slate-200 shadow-sm overflow-hidden max-h-[800px] overflow-y-auto custom-scrollbar">
                <div className="p-6 border-b border-slate-100 flex flex-col md:flex-row items-center justify-between gap-4">
                    <h2 className="text-lg font-bold text-slate-900">Active Molecular Biology Projects</h2>
                                    ...
                                    <tr key={project._id} className="hover:bg-slate-50/50 transition-colors">
                                        ...
                                        <td className="px-6 py-4 text-right">
                                            <div className="flex items-center justify-end gap-2" onClick={(e) => e.stopPropagation()}>
                                                <Link
                                                    href={`/manager-dashboard/service/molecular-biology/project/${project._id}`}
