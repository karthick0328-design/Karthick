        ...
        return (
            <div className="min-h-[400px] flex items-center justify-center">
                <div className="text-center">
                    <Dna className="w-12 h-12 text-blue-600 animate-spin mx-auto mb-4" />
    ...
    if (!project) {
        return (
            <div className="text-center py-20">
                ...
                <Link href="/manager-dashboard/service/molecular-biology" className="text-blue-600 font-semibold hover:underline flex items-center justify-center gap-2">
    ...
    return (
        <div className="font-sans">
            ...
            <ServiceProjectDetailView
                ...
                serviceTitle="Molecular Biology Unit"
                serviceIcon={<Dna className="w-5 h-5" />}
                breadcrumb="MANAGER DASHBOARD / SERVICE / MOLECULAR BIOLOGY"
                backUrl="/manager-dashboard/service/molecular-biology"
                workflowBar={
                    <div className="p-10">
                        <div className="relative flex items-center justify-between max-w-4xl mx-auto">
                            ...
                            {[
                                ...
                                { step: 2, label: 'Cross-Dept', icon: GitBranch },
                                { step: 3, label: 'Lead Assign', icon: UserPlus },
                                { step: 4, label: 'Sequencing', icon: Activity }
                            ].map((item) => {
                            ...
                            <div className="space-y-4 mb-6">
                                <label className="block">
                                    ...
                                    <input
                                        ...
                                        placeholder="e.g., DNA Extraction Complete"
                                    />
                                </label>
                                <label className="block">
                        ...
                        <div className="bg-white rounded-2xl shadow-2xl max-w-lg w-full p-8 animate-in zoom-in duration-200">
                            ...
                            <div className="space-y-4 mb-6">
                                <div className="grid grid-cols-2 gap-4">
                                    <button
                                        ...
                                        className={`p-4 rounded-xl border-2 flex flex-col items-center gap-2 transition-all ${reviewStatus === 'Approved' ? 'border-blue-500 bg-blue-50 text-blue-700' : 'border-gray-100 hover:border-blue-200'
                                            }`}
                                    >
                                    ...
                                    <label className="block">
                                        ...
                                        <div className="relative">
                                            ...
                                            <input
                                                ...
                                                className="w-full pl-10 pr-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent font-bold text-lg"
                                                placeholder="0.00"
                                            />
                                        </div>
                                ...
                                <label className="block">
                                    ...
                                    <textarea
                                        ...
                                        className="w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent min-h-[100px]"
                            ...
                            <div className="flex gap-3">
                                <button
                                    ...
                                    className={`flex-1 py-3 rounded-xl font-bold shadow-lg transition-all disabled:opacity-50 flex items-center justify-center gap-2 ${reviewStatus === 'Approved' ? 'bg-blue-600 text-white hover:bg-blue-700' : 'bg-rose-600 text-white hover:bg-rose-700'
                                        }`}
                                >
