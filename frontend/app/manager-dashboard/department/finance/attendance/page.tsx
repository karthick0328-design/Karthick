            ...
            <div className="max-w-7xl mx-auto space-y-8">
                ...
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <h1 className="text-4xl font-extrabold text-gray-900 tracking-tight text-center lg:text-left">
                            Finance <span className="text-indigo-600">Attendance</span>
                        </h1>
                        <p className="text-lg text-gray-500 mt-2 max-w-2xl text-center lg:text-left">
                            Daily check-in and leave management portal for Finance Personnel.
                        </p>
                    </div>
                </div>
...
export default FinanceAttendancePage;
