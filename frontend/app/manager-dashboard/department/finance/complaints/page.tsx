...
import Sidebar from '@/app/Manager-Compontent/finance/common/FinanceServiceSidebar';
    ...
    return (
        <div className="min-h-screen bg-slate-50/50 flex">
            ...
            <div className={`flex-1 transition-all duration-500 ease-in-out ${isSidebarOpen ? 'ml-72' : 'ml-24'}`}>
                ...
                <main className="p-8">
                    <div className="mb-8">
                        <h1 className="text-3xl font-black text-slate-900 tracking-tight">Financial Complaints Hub</h1>
                        <p className="text-slate-500 mt-2 font-medium">Resolution center for payment disputes, billing inquiries, and service financial escalations.</p>
                    </div>
