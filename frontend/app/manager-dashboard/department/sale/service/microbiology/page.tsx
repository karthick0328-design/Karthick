...
const DEPARTMENT = 'Microbiology';

// --- Main Page Component ---
export default function MicrobiologySalesPage() {
    ...
    return (
        <div className="space-y-8 animate-in fade-in duration-500">
            ...
            <ServiceDashboardView
                ...
                serviceIcon={<Bug className="w-6 h-6 text-white" />}
            />
