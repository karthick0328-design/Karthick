...
const DEPARTMENT = 'NGS';

// --- Main Page Component ---
export default function NGSSalesPage() {
    ...
    useEffect(() => {
        if (quoteAmount && !gst && !taxHandling && !projectProgress) {
            ...
            setProjectProgress('1. Sample QC & Library Prep\n2. High-Throughput Sequencing\n3. Bioinformatics Pipeline Processing\n4. Data Analysis & Insights Report');
        }
    }, [quoteAmount]);
    ...
    return (
        <div className="space-y-8 animate-in fade-in duration-500">
            ...
            <ServiceDashboardView
                ...
                serviceIcon={<Layers className="w-6 h-6 text-white" />}
            />
