...
// --- Main Page Component ---
export default function SoftwareDevelopmentSalesPage() {
    ...
    useEffect(() => {
        if (quoteAmount && !gst && !taxHandling && !projectProgress) {
            ...
            setProjectProgress('1. Requirements Analysis & SRS\n2. UI/UX Design & Architecture\n3. Development Core Sprints\n4. Quality Assurance & Deployment Prep');
        }
    }, [quoteAmount]);
    ...
    return (
        <div className="space-y-8 animate-in fade-in duration-500">
            ...
            <ServiceDashboardView
                ...
                serviceIcon={<Monitor className="w-6 h-6 text-white" />}
            />
