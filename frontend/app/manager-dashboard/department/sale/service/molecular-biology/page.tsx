...
const DEPARTMENT = 'Molecular Biology';

// --- Main Page Component ---
export default function MolecularBiologySalesPage() {
    ...
    useEffect(() => {
        if (quoteAmount && !gst && !taxHandling && !projectProgress) {
            ...
            setProjectProgress('1. DNA/RNA Extraction\n2. Gene Cloning & Vector Prep\n3. Transformation & Verification\n4. Protocol Optimization & Reporting');
        }
    }, [quoteAmount]);
    ...
    return (
        <div className="space-y-8 animate-in fade-in duration-500">
            ...
            <ServiceDashboardView
                ...
                serviceIcon={<Dna className="w-6 h-6 text-white" />}
            />
