    ...
    return (
        <div className="min-h-screen bg-slate-50/50 flex">
            <Sidebar 
                ...
                pathname="/manager-dashboard/department/sale/complaints" 
            ...
            <div className={`flex-1 transition-all duration-500 ease-in-out ${isSidebarOpen ? 'ml-72' : 'ml-24'}`}>
                ...
                <main className="p-8">
                    <div className="mb-8">
                        <h1 className="text-3xl font-black text-slate-900 tracking-tight text-center lg:text-left">Sales Complaints Center</h1>
                        <p className="text-slate-500 mt-2 text-center lg:text-left font-medium">Manage and resolve client inquiries and service-level escalations.</p>
                    </div>
